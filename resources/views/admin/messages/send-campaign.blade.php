...
<div class="container-fluid">
    <div class="row">
        <div class="card">
            <div class="card-body">
                <form class="form-horizontal form-material mx-2" action="{{ route('admin.process-campaign') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    {{-- <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" placeholder="isi header disini"
                                class="form-control form-control-line @error('header') is-invalid @enderror" name="header">
                                @error('header')
                                    <span class="invalid-feedback">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    {{-- <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" placeholder="isi footer disini"
                                class="form-control form-control-line @error('footer') is-invalid @enderror" name="footer">
                                @error('footer')
                                    <span class="invalid-feedback">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <button type="submit" class="btn btn-primary text-white">Send Campaign Message</button>
                        </div>
                    </div>
                </form>
            </div>
