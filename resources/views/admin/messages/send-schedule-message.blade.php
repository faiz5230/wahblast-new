...
<div class="container-fluid">
    <div class="row">
        <div class="card">
            <div class="card-body">
                <form class="form-horizontal form-material mx-2" action="{{ route('admin.process-schedule-message') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" placeholder="contoh : 6289519069792"
                                class="form-control form-control-line @error('number') is-invalid @enderror" value="{{ old('number') }}" name="number" data-role="tagsinput">
                                @error('number')
                                    <span class="invalid-feedback">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <input type="date" id="schedule-date"
                                class="form-control form-control-line @error('schedule_date') is-invalid @enderror" value="{{ old('schedule_date') }}" name="schedule_date">
                            @error('schedule_date')
                                <span class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="time" id="schedule-time"
                                class="form-control form-control-line @error('schedule_time') is-invalid @enderror" value="{{ old('schedule_time') }}" name="schedule_time">
                            @error('schedule_time')
                                <span class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </span>
