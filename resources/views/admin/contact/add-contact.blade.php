...
<div class="page-breadcrumb">
    <div class="row align-items-center">
        <div class="col-6">
            ...
            <h1 class="mb-0 fw-bold">Add Contact</h1> 
        </div>
    </div>
</div>
<!-- ============================================================== -->
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-xlg-9 col-md-7" style="max-width: 500px">
            <div class="card">
                <div class="card-body">
                    <form class="form-horizontal form-material mx-2" action="{{ route('admin.contacts.storeContact') }}" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="6289519069792"
                                    class="form-control form-control-line @error('phone_number') is-invalid @enderror" name="phone_number">
                                    @error('phone_number')
                                        <span class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <button type="submit" class="btn btn-primary text-white">Add Contact</button>
                            </div>
                        </div>
                    </form>
                </div>
