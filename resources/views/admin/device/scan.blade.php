        ...
        <div class="col-6">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 d-flex align-items-center">
                  ...
                  <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.device') }}" style="text-decoration: none; color: #6C757D;">Device</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="_2WuPw">
                      ...
                      <div class="col-sm-6">
                          <img src="{{ $data['result'] }}" alt="" style="height:300px">
                      </div>
                </div>
            </div>
        </div>
