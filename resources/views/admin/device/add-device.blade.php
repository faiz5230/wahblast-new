...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-xlg-9 col-md-7" style="max-width: 500px">
            <div class="card">
                <div class="card-body">
                    <form class="form-horizontal form-material mx-2" action="{{ route('admin.device.postDevice') }}" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="Masukkan Deskripsi"
                                    class="form-control form-control-line @error('description') is-invalid @enderror" name="description">
                                    @error('description')
                                        <span class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </span>
