...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/images/wah-logo.png') }}" type="image/x-icon">
    ...
    <title>Login - {{  App\Models\AppSetting::getValue('app_name') }}</title>
  </head>
  <body>
  

  <div class="d-lg-flex half">
    <div class="bg order-1 order-md-2" style="background-image: url('/login-template/images/bg_1.jpg');"></div>
    <div class="contents order-2 order-md-1">

      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7">
            <h3>Login to <strong>{{  App\Models\AppSetting::getValue('app_name') }}</strong></h3>
            <p class="mb-4">{{  App\Models\AppSetting::getValue('app_name') }}.</p>
