...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="card">
            <div class="card-body">
                <form class="form-horizontal form-material mx-2" action="{{ route('admin.process-group-message') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{-- <div class="form-group">
                        <label class="col-md-12">Group ID </label>
                        <div class="col-md-12">
                            <input type="text" placeholder="Masukkan Group ID"
