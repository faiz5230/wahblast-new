                        ...
                        <div class="card chat-app">
                            <div id="plist" class="people-list" style="background-color: #fff">
                                ...
                                <ul class="list-unstyled chat-list mt-2 mb-0">
                                    @foreach ($getListChats as $chats)
                                        <a href="{{ route('admin.chats', $chats->id) }}" style="color:black;">
                                            <li class="clearfix">
                                                <img src="https://bootdey.com/img/Content/avatar/avatar1.png" alt="avatar">
                                                <div class="about">
                                                    <div class="name">{{ trim($chats->id,"@s.whatsapp.net") }}&nbsp;<span class="badge bg-secondary">{{ $chats->unreadCount }}</span></div>
                                                    <div class="status"> <i class="fa fa-circle offline"></i> {{ date('H:i:s',$chats->conversationTimestamp) }} </div>                                            
                                                </div>
                                            </li>
                                        </a>
                                    @endforeach
                            ...
                            <div class="chat">
                                ...
                                flex-direction: column-reverse;">
                                    <ul class="m-b-0" >
                                        {{-- @foreach ($getChatDecode->data as $chat) --}}
                                        {{-- <li class="clearfix">
                                            ...
                                            {{-- </div>
                                                <div class="message other-message float-right"> {{ print_r(json_encode($chat->message)) }} </div> --}}
                                            {{-- @if($chat->status == 1)
                                        ...
                                        @endforeach --}}
                                        @foreach ($getChatFormatter['data'] as $chat)
                                        <li class="clearfix">
                                            <div class="message-data text-right" style="text-align: center;">
                                                {{-- <span class="message-data-time badge bg-secondary" style="color: white; border-radius: 5px;">{{ date('G:i:s', $chat['messageTimestamp']) }}</span> --}}
                                                {{-- <img src="https://bootdey.com/img/Content/avatar/avatar7.png" alt="avatar"> --}}
                                            </div>
                                            @if ($chat['key']['fromMe']==true)
                                                
                                            @if(!empty($chat['message']['conversation']))
                                            <div class="message other-message float-right"> {{ $chat['message']['conversation'] }} </div>
                                            @else
                                            <div class="message other-message float-right"> {{ $chat['message']['extendedTextMessage']['text'] }} </div>
                                            @endif
                                        ...
                                        <li class="clearfix">
                                            ...
                                            <div class="message my-message"> {{ $chat }} </div>
                                            @else
                                            <div class="message my-message"> {{ $chat['message']['extendedTextMessage']['text'] }} </div>
                                            @endif                                 
                                        </li>    
                                            @endif
                                        @endforeach 
